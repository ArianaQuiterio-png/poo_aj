class Banco:
    def __init__(self,no_clientes,no_elementos_seguridad,
                 no_edificios,sistema_informatico,nombre_banco,
                 no_cajeros,fiable,capital,
        ...
        print(f"Fiabilidad {self.fiable}")
        print(f"Capital {self.capital}")
        print(f"Horario de atencion {self.horario_atencion}")
        print(f"Color del banco {self.color_banco}")
acme= Banco (10000,None,None,"ACME 01","ACME",1000,True,
             "$1000000","9:00 am A 19:00 pm","verde fosforecente")
